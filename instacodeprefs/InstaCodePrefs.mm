...
@interface InstaCodePrefsListController: PSListController
- (void)respring;
- (void)followLogan;
@end

@implementation InstaCodePrefsListController
- (id)specifiers {
	if(_specifiers == nil) {
		_specifiers = [[self loadSpecifiersFromPlistName:@"InstaCodePrefs" target:self] retain];
	}
	return _specifiers;
}
...
- (void)viewDidLoad {
    ...
    UIImage* customImg = [UIImage imageWithContentsOfFile:@"/Library/PreferenceBundles/InstaCodePrefs.bundle/twitterbutton.png"];
...
- (void)viewDidAppear:(BOOL)animated {
    NSString *iname = @"/Library/PreferenceBundles/InstaCodePrefs.bundle/InstaCodePrefs.png";
...
- (void)share:(UIBarButtonItem *)sender {
    ...
    [tweetComposeViewController setInitialText:@"#InstaCode - Merge the date and passcode view! Developed by @logandev22"];
...
@interface InstaCodeCustomCell : PSTableCell <PreferencesTableCustomView> {
	UILabel *label;
	UILabel *underLabel;
	UILabel *otherLabel;
}
...
@implementation InstaCodeCustomCell
- (id)initWithSpecifier:(id)specifier {
	...
	if (self) {
		...
		[underLabel setText:@"Merge the date and passcode view!"];
